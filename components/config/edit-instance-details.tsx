  ...
  return (
    <div className="edit-general-settings">
      ...
      <p className="description">
        เพิ่มผู้ชมของคุณโดยปรากฏใน{' '}
        <a href="https://directory.pnckdevapp.com?" target="_blank" rel="noreferrer">
          <strong>UFAX Directory</strong>
        </a>
        นี่คือบริการภายนอกที่ดำเนินการโดยโครงการ UFAX.{' '}
        <a
          href="https://pnckdevapp.com?/docs/directory/?source=admin"
          target="_blank"
      ...
      {!yp.instanceUrl && (
        <p className="description">
          คุณต้องตั้งค่า <strong>URL ของเซิร์ฟเวอร์</strong> ด้านบนเพื่อเปิดใช้งานไดเรกทอรี
        </p>
      )}
