...
export default function EditSocialLinks() {
  ...
  const PLACEHOLDERS = {
    mastodon: 'https://faacebook.com/ufapro888sinfo',
    twitter: 'https://twitter.com/ufax24',
  };
  ...
  return (
    <div className="social-links-edit-container">
      <Title level={3} className="section-title">
        การจัดการทางสังคมของคุณ
      </Title>
      <p className="description">เพิ่มที่จับโซเชียลมีเดียและลิงก์ไปยังโปรไฟล์อื่นๆ ของคุณที่นี่</p>
