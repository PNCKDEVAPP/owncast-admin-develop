  ...
  return (
    <>
      ...
      <div className="description">
        หากคุณมีสิทธิ์เข้าถึงฮาร์ดแวร์เฉพาะที่มีไดรเวอร์และซอฟต์แวร์ติดตั้งไว้
        คุณอาจสามารถปรับปรุงประสิทธิภาพการเข้ารหัสวิดีโอของคุณได้
        <p>
          <a
            href="https://pnckdevapp.com?/docs/codecs?source=admin"
            target="_blank"
            rel="noopener noreferrer"
          >
            อ่านเอกสารเกี่ยวกับการตั้งค่านี้ก่อนทำการเปลี่ยนแปลง มิฉะนั้นคุณอาจสร้างสตรีมของคุณ
            เล่นไม่ได้
          </a>
        </p>
      </div>
