  ...
  return (
    <div className="config-video-latency-container">
      ...
      <p className="description">
        แม้ว่าจะเป็นเรื่องปกติที่จะต้องการให้เวลาแฝงของคุณต่ำที่สุดเท่าที่จะเป็นไปได้
        แต่คุณอาจประสบปัญหา ความทนทานต่อข้อผิดพลาดและความเสถียรลดลงเมื่อใช้งานในระดับต่ำ
        ค่าต่ำสุดไม่ใช่ ที่แนะนำ.
      </p>
      <p className="description">
        สำหรับสตรีมแบบสดเชิงโต้ตอบ คุณอาจต้องการทดสอบด้วยเวลาแฝงที่ต่ำกว่า for
        การออกอากาศแบบไม่โต้ตอบที่คุณอาจต้องการเพิ่ม{' '}
        <a
          href="https://pnckdevapp.com?/docs/encoding#latency-buffer?source=admin"
          target="_blank"
