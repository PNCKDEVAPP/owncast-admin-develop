  ...
  return (
    <div className={classes}>
      <p className="description">
        <a
          href="https://pnckdevapp.com?/docs/video?source=admin"
          target="_blank"
          rel="noopener noreferrer"
        >
          Learn more
        </a>{' '}
        ว่าการตั้งค่าแต่ละรายการจะส่งผลต่อประสิทธิภาพของเซิร์ฟเวอร์ของคุณอย่างไร
      </p>

      {videoPassthroughEnabled && (
        <p className="passthrough-warning">
          หมายเหตุ: Video Passthrough สำหรับตัวแปรสตรีมเอาต์พุตนี้ <em>เปิดใช้งาน</em> ปิดใช้งาน
          ด้านล่างการตั้งค่าการเข้ารหัสวิดีโอ
        </p>
      )}
      ...
      <Row gutter={16}>
        ...
        <Col sm={24} md={12}>
          <div className="form-module cpu-usage-container">
            ...
            <p className="description">
              ลดเพื่อปรับปรุงประสิทธิภาพของเซิร์ฟเวอร์ หรือเพิ่มเพื่อปรับปรุงคุณภาพวิดีโอ
            </p>
            ...
            <p className="read-more-subtext">
              ซึ่งอาจหมายถึงการใช้งาน GPU หรือ CPU ขึ้นอยู่กับสภาพแวดล้อมเซิร์ฟเวอร์ของคุณ.{' '}
              <a
                href="https://pnckdevapp.com?/docs/video/?source=admin#cpu-usage"
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <Collapse className="advanced-settings">
        <Panel header="Advanced Settings" key="1">
          <Row gutter={16}>
            <Col sm={24} md={12}>
              <div className="form-module resolution-module">
                ...
                <p className="description">
                  การปรับขนาดเนื้อหาของคุณจะใช้ทรัพยากรเพิ่มเติมบนเซิร์ฟเวอร์ของคุณ ถ้าคุณต้องการ
                  หากต้องการปรับขนาดเนื้อหาของคุณสำหรับเอาต์พุตสตรีมนี้ คุณควรเลือกอย่างใดอย่างหนึ่ง
                  กำหนดความกว้าง <strong>หรือ</strong> ความสูงเพื่อรักษาอัตราส่วนภาพของคุณ.{' '}
                  <a
                    href="https://pnckdevapp.com?/docs/video/?source=admin"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <Col sm={24} md={12}>
              ...
              <div className="form-module video-passthrough-module">
                ...
                <div className="description">
                  <p>
                    การเปิดใช้การส่งผ่านวิดีโออาจทำให้ใช้ฮาร์ดแวร์น้อยลง แต่ก็อาจเช่นกัน
                    ทำให้สตรีมของคุณ<strong>เล่นไม่ได้</strong>.
                  </p>
                  <p>
                    การตั้งค่าอื่นๆ ทั้งหมดสำหรับเอาต์พุตสตรีมนี้จะถูกปิดใช้งานหากการส่งผ่านคือ
                    ใช้แล้ว.
                  </p>
                  <p>
                    <a
                      href="https://pnckdevapp.com?/docs/video/?source=admin#video-passthrough"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      อ่านเอกสารก่อนเปิดใช้งาน เนื่องจากจะส่งผลต่อการสตรีมของคุณ
                    </a>
                  </p>
                </div>
                <Popconfirm
          ...
          <div className="form-module frame-rate-module">
            ...
            <p className="read-more-subtext">
              <a
                href="https://pnckdevapp.com?/docs/video/?source=admin#framerate"
                target="_blank"
                rel="noopener noreferrer"
              >
