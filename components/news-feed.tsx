...
const OWNCAST_FEED_URL = 'https://pnckdevapp.com?news/index.json';
const OWNCAST_BASE_URL = 'https://pnckdevapp.com?';
...
export default function NewsFeed() {
  ...
  return (
    <section className="news-feed form-module">
      <Title level={2}>ข่าวคราวเงียบหาย &amp; ไปสองสามปี Updates from ADMIN</Title>
      {loadingSpinner}
      {feed.map(item => (
