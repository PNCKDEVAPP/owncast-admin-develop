  ...
  const questions = [
    {
      ...
      content: (
        <div>
          <a
            href="https://pnckdevapp.com?/docs/configuration/?source=admin"
            target="_blank"
    ...
    },
    {
      ...
      content: (
        <div>
          <a
            href="https://pnckdevapp.com?/docs/website/?source=admin"
            target="_blank"
            rel="noopener noreferrer"
          >
            <LinkOutlined /> Learn more
    ...
    },
    {
      ...
      content: (
        <div>
          <a
            href="https://pnckdevapp.com?/docs/encoding/?source=admin"
            target="_blank"
            rel="noopener noreferrer"
          >
            <LinkOutlined /> Learn more
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <a
            href="https://pnckdevapp.com?/docs/faq/?source=admin"
            target="_blank"
            rel="noopener noreferrer"
          >
            {' '}
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <a
            href="https://pnckdevapp.com?/thirdparty?source=admin"
            target="_blank"
            rel="noopener noreferrer"
          >
            &nbsp;developer APIs.&nbsp;
      ...
      <Row gutter={[16, 16]} justify="space-around" align="middle">
        <Col xs={24} lg={12} style={{ textAlign: 'center' }}>
          ...
          <Button
            target="_blank"
            rel="noopener noreferrer"
            href="https://pnckdevapp.com?/docs/troubleshooting/?source=admin"
            icon={<LinkOutlined />}
            type="primary"
          >
            Fix your problems
        ...
        <Col xs={24} lg={12} style={{ textAlign: 'center' }}>
          ...
          <Button
            target="_blank"
            rel="noopener noreferrer"
            href="https://pnckdevapp.com?/docs?source=admin"
            icon={<LinkOutlined />}
            type="primary"
          >
            Read the Docs
